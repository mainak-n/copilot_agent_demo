...
function resetLoop() {
    ...
    isFirstMessage = false; // It's a reset, so treat as fresh but don't double trigger
        ...
        <div class="msg bot" id="${id}">
            ...
            <div class="adaptive-card" style="width:320px;">
                ...
                <div style="display:flex; flex-direction:column; gap:8px;">
                    ...
                    <button style="text-align:left; padding:10px; border:1px solid #ddd; background:white;" onclick="handleDiscountSelection('${id}', 20)"><strong>Aggressive</strong> (20%) (Approval Required)</button>
                </div>
            </div>
        </div>`;
        chat.insertAdjacentHTML('beforeend', html);
...
function handleDiscountSelectionUI(id, discount) {
    ...
    if (qtyInput && qtyInput.value.trim() !== "") clientData.quantity = parseInt(qtyInput.value);
    if (descInput && descInput.value.trim() !== "") clientData.description = descInput.value.trim();
